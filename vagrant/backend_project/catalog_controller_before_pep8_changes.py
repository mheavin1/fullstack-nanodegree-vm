...
def itemsForCategory(category_name):
    ...
    return render_template('categoryitems2.html',
...
def itemInfo(category_name, item_title):
    ...
    if 'username' not in login_session or (
        ...
        return render_template('iteminfo2.html',
                               item=item, category_id = category.id)
    else:
        print("rendering private page")
        return render_template('iteminfo_loggedin2.html',
                               item=item, category_id = category.id)
...
def editItem(item_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('edititem2.html', item=item,
                               cat_dict=cat_dict)
...
def deleteItem(item_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('deleteitem2.html', item=item)
